...
<p align = 'center'><img src="https://latex.codecogs.com/gif.latex?P_{ans}=exp \left(\frac{w_slogP_s+w_elogP_e}{w_s+w_e}\right)" /></p>
...
<p align = 'center'><img src="https://latex.codecogs.com/gif.latex?P=exp \left(\frac{w_{nsp}logP_{nsp}+w_{ans}logP_{ans}}{w_{nsp}+w_{ans}}\right)" /></p>
