...
def load_xlnet_from_ckpt(ckpt_path,
                         batch_size,
                         memory_len,
                         target_len,
                         dropout=0.0,
                         ...
                         **kwargs):
    import os
    config_path = os.path.join(ckpt_path, 'xlnet_config.json')
    checkpoint_path = os.path.join(ckpt_path, 'xlnet_model.ckpt')
