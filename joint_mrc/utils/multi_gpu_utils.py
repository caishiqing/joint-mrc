...
from . import keras, utils
from . import backend as K

concatenate = keras.layers.merge.concatenate
Lambda = keras.layers.core.Lambda
Model = keras.engine.training.Model
clone_model = keras.models.clone_model
to_list = utils.generic_utils.to_list
...
def multi_gpu_model(model,
    ...
    # Arguments
        ...
        first_gpu: A boolean value to identify whether to use 
            first gpu for forward and backward propagation, if false,
            it is only used for intergration grads.
